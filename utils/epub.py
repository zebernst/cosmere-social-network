...
content_map = {
    ...
    "mistborn/era1/final-empire": re.compile(r"^x_(ch\d+|fm02)"),
    "mistborn/era1/well-of-ascension": re.compile(r"^x_(ch\d+|bm01)"),
...
def tokenize_chapters(key: str):
    ...
    files = [
        (c.attrib["id"], chapter_dir / c.attrib["href"])
        for c in content_opf.findall(
            "opf:manifest/*[@media-type='application/xhtml+xml']",
